...
**Note** Before running the following command, replace the ${HOME} with the path to your home directory.
...
```
echo "[engine:junit-vintage]/[runner:com.example.MySampleTest]/[test:testNativeImage(com.example.MySampleTest)]" > target/test-ids/junit-platform-unique-ids.txt
```
